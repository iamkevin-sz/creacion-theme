...
/*
    ...
    Plugin URI:
    Description: Anade widgetspersonalizados al sitio gym fitness
    Version: 1.0.0
...
// esta linea quierer decir si alguien intenta abrir la ruta completa de este plugin este codigo no le mostrara nada, es decir que no pueden acceder al archivo desde el navegador
if(!defined('ABSPATH')) die();

/**
 * Adds Gymfitness widget.
 */
class GymFitness_Clases_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		$cantidad = !empty( $instance['cantidad'] ) ? $instance['cantidad'] : esc_html__( '¿Cuantas Clases Clases deseas Mostra?', 'gymfitness' );?>
		<p>
